        ...
        if (count < 6 && found !== word.length) {
          ...
          if (wordWithoutAccent.includes(letterKeyPushed)) {
            ...
            word.forEach((letterWord, index) => {
              ...
              const letterWithoutAccent = letterWord
                .normalize("NFD")
                .replace(/[\u0300-\u036f]/g, "");
...
function endGame(gamer) {
  ...
  if (gamer.wonPart === 0) {
    ...
    endGameMessage.innerHTML +=
      gamer.wonPart > gamer.lostPart
        ? `<img src="media/gifgagne.webp" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen" allowFullScreen>Bravo tu as gagné ${gamer.wonPart} ${winMessage} sur ${partMax}`
        : `<img src="media/gifperdu.webp" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen" allowFullScreen>Dommage, tu n'as gagné que ${gamer.wonPart} ${winMessage} sur ${partMax}<br/>Retente ta chance`;
  }
